...
{
	return (char) ((((int) (((xorshift96())))&0XFF) * (maxval-minval))>>8) + minval;
}
...
{
	return (unsigned char) ((((unsigned int) (((xorshift96()))) & 0XFF) * (maxval-minval))>>8) + minval;
}
...
{
	return (char) ((((int) (((xorshift96())))& 0xFF) * maxval)>>8);
}
...
{
	return (unsigned char) ((((unsigned int) (((xorshift96())))&0xFF) * maxval)>>8);
}
